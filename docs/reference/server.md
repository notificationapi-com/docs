...
| `user.timezone`              | string                        | User time zone. Time zone names correspond to the Zone and Link names of the IANA Time Zone Database, such as 'UTC', 'Asia/Shanghai', 'Asia/Kolkata', and 'America/New_York'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `timezone`      | string   | User time zone. Time zone names correspond to the Zone and Link names of the IANA Time Zone Database, such as 'UTC', 'Asia/Shanghai', 'Asia/Kolkata', and 'America/New_York'.            |
