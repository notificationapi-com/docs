...
Download [this file](../../assets/files/notificationapi-service-worker.zip), unzip the download, and place the `notificationapi-service-worker.js` in the "public" folder of your web application. For example, if you are using react, the file should go in the `public` folder.
